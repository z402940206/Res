...
<table id="dg" title="新闻信息管理" class="easyui-datagrid" fitColumns="true"
	pagination="true" rownumbers="true" url="__URL__/noticelist" fit="true"
	toolbar="#tb">
	<thead>
		<tr>
			<th field="id" checkbox="true" width="auto"></th>
			<th field="title" width="auto">标题</th>
			<th field="content" width="auto">内容</th>
			<th field="pic_path" width="auto">图片路径</th>
			<th field="time" width="auto">时间</th>
			<th field="moreContent" width="auto">详细内容</th>
		</tr>
	</thead>
</table>
<!-- 工具栏 -->
...
<div id="dlg" class="easyui-dialog"
	style="padding: 10px 20px; height: 300px; width: 400px;"
	...
	<form id="fm" class="easyui-form" method="post"
		...
		<table>
			...
			<tr height="50">
				...
				<td><textarea name="content" class="easyui-textbox"
					data-options="required:true"></textarea> </td>
			</tr>
			<tr height="50">
				<td style="font-weight: bold;">图片路径：</td>
				<td><input name="pic_path" class="easyui-textbox"
					data-options="required:true"></td>
			</tr>
			<tr height="50">
			...
			<tr height="50">
				<td style="font-weight: bold;">详细内容：</td>
				<td><textarea name="moreContent" class="easyui-textbox"
					data-options="required:true"></textarea> </td>
			</tr>
		</table>
	</form>
