...
<table id="dg" title="评论信息管理" class="easyui-datagrid" fitColumns="true"
...
<div id="dlg" class="easyui-dialog"
	style="padding: 10px 20px; height: 300px; width: 350px;"
	...
	<form id="fm" class="easyui-form" method="post"
		...
		<table>
			...
			<tr>
				<td style="font-weight: bold; vertical-align: top;">时间：</td>
