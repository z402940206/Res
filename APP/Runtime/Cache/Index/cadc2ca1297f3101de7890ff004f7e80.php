...
<body>
	...
	<h3>图集</h3>
		 ...
		 <div class="gallery-bottom">
		 		<?php if(is_array($date)): foreach($date as $key=>$v): ?><div class="col-md-4 gallery-left">
						<a href="<?php echo ($v["pic_add"]); ?>">
							<img src="<?php echo ($v["pic_add"]); ?>" alt="name" />
						</a>
...
<script src="__ROOT__/Public/js/jquery.chocolat.js"></script>
<link rel="stylesheet" href="__ROOT__/Public/css/chocolat.css" type="text/css"/>
 <!-- Javascript calls -->
	<script type="text/javascript" charset="utf-8">
		$(function() {
		 $('#portfolio a').Chocolat({overlayColor:'#000',leftImg:'__ROOT__/Public/images/leftw.gif',rightImg:'__ROOT__/Public/images/rightw.gif',closeImg:'__ROOT__/Public/images/closew.gif'});
	   });
</script>
	 </div>
</div>	
