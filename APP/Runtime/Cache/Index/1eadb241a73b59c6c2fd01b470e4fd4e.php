		...
		<div class="container">
			...
			<div class="news-grids" id="news-grids">
				<?php if(is_array($news)): foreach($news as $key=>$v): ?><div class="col-md-3 news-grid wow bounceIn animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
					<a href=<?php echo U('Index/Single',array('tid'=>$v.id));?>><?php echo ($v["title"]); ?></a>
					<span><?php echo ($v["time"]); ?></span>
					<a class="mask" href=<?php echo U('Index/Single');?>><img src=<?php echo ($v["pic_path"]); ?> class="img-responsive zoom-img" alt="" /></a>
					<div class="news-info">
						<p><?php echo ($v["content"]); ?></p>
						<a class="button" href="single.html"><img src="__ROOT__/Public/images/read.png" alt=""></a>
					</div>
