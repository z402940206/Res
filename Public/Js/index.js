...
$(function () {
	...
	$( '#send-btn' ).click( function () {
		...
		if(content.val()==''){
			...
			$.post(handleUrl,{title : title.val(),content : content.val()},
				function(data){
					if(data.status){
						var str='<div class="col-md-3 news-grid wow bounceIn animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">';
			str+='<a href="/design/index.php/Index/Single.html">'+data.title+'</a>';
			str+='<span>'+data.time+'</span>';
			str+='<a class="mask" href="/design/index.php/Index/Single.html">';
			str+='<a href="Single?tid='+data.id+'"><img src="/design/Public/images/img4.jpg"';
			str+='class="img-responsive zoom-img" alt="" /></a>';
			str+='</a>';
			str+='<div class="news-info">';
			str+='<p>'+data.content+'</p>';
			str+='<a class="button" href="/design/index.php/Index/Single.html"><img src="/design/Public/Images/read.png" alt="">';
			str+='</a></div>';


			$('#news-grids').append(str);
			$('#close').click();
